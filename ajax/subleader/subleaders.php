...
include ('../../config/conn.php');
 ...
 if($search_str==''){
    $query = "SELECT * FROM user_tbl WHERE leader_id=".$leader_id." ORDER BY id DESC LIMIT $start_from, $record_per_page";  
 }else{
    $query = "SELECT * FROM user_tbl WHERE leader_id=".$leader_id." AND (f_name LIKE '%".$search_str."%' OR l_name LIKE '%".$search_str."%' OR email LIKE '%".$search_str."%' OR phone LIKE '%".$search_str."%') ORDER BY id DESC LIMIT $start_from, $record_per_page";  
 }
...
if($search_str==''){
 $page_query = "SELECT * FROM user_tbl WHERE leader_id=".$leader_id." ORDER BY id DESC";  
}else{
 $page_query = "SELECT * FROM  user_tbl WHERE leader_id=".$leader_id." AND (f_name LIKE '%".$search_str."%' OR l_name LIKE '%".$search_str."%' OR email LIKE '%".$search_str."%' OR phone LIKE '%".$search_str."%') ORDER BY id DESC";  
}
